...
SMSC_LOGIN = os.environ.get('SMSC_LOGIN')       # логин клиента
SMSC_PASSWORD = os.environ.get('SMSC_PASSWORD')    # пароль
SMSC_POST = os.environ.get('SMSC_POST')        # использовать метод POST
SMSC_HTTPS = os.environ.get('SMSC_HTTPS')       # использовать HTTPS протокол
SMSC_CHARSET = os.environ.get('SMSC_CHARSET')     # кодировка сообщения (windows-1251 или koi8-r), по умолчанию используется utf-8
SMSC_DEBUG =os.environ.get('SMSC_DEBUG')        # флаг отладки

# Константы для отправки SMS по SMTP
SMTP_FROM = os.environ.get('SMTP_FROM')     # e-mail адрес отправителя
SMTP_SERVER = os.environ.get('SMTP_SERVER')   # адрес smtp сервера
SMTP_LOGIN = os.environ.get('SMTP_LOGIN')    # логин для smtp сервера
SMTP_PASSWORD = os.environ.get('SMTP_PASSWORD') # пароль для smtp сервера
